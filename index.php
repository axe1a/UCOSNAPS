	...
	<div class="insertPhotoForm" style="display: flex; justify-content: center;">
		...
		<form action="core/handleForms.php" method="POST" enctype="multipart/form-data">
            ...
            <select name="album_id">
                ...
                <?php 
                // Fetch user's albums
                $userAlbums = getAllAlbums($pdo, $_SESSION['username']);
			...
			<div class="images" style="display: flex; justify-content: center; margin-top: 25px;">
				<div class="photoContainer" style="background-color: ghostwhite; border-style: solid; border-color: gray;width: 25%;">
					...
					<div class="photoDescription" style="padding:25px;">
						...
						<!-- Show Album if photo is in an album -->
						<?php 
						if (!empty($row['album_id'])) {
							$album = getAlbumById($pdo, $row['album_id']);
							echo "<p>Album: <a href='view-album.php?album_id={$row['album_id']}'>" . 
								htmlspecialchars($album['album_name']) . 
								"</a></p>";
						}
						?>
